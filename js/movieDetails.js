    ...
    document.getElementById("movieDetails").innerHTML = `
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="index.html" id="backToMovies" class="btn btn-secondary"><i class="fas fa-arrow-left icon"></i>Back to Movies</a>
        </div>
      </div>
      ...
      <section class="similar-movies">
        <h3><i class="fas fa-th-large icon"></i> Similar Movies</h3>
        <div class="row">
            ...
            <div class="movie-card col-md-3">
              <a href="moviePage.html?movieId=${movie.id}" class="movie-card-link text-decoration-none">
                ...
                <div class="movie-card-body">
                  ...
                  <p class="movie-card-date"><i class="fas fa-calendar-alt icon"></i>${movie.release_date}</p>
                </div>
              </a>
            </div>`
            )
